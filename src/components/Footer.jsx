...
const Footer = () => {
  return (
    <footer className="bg-white/80 backdrop-blur-lg border-t border-slate-200/50 mt-16">
        ...
        <div className="glass-morphism rounded-2xl p-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-blue-600">Mission:</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
              <h4 className="font-semibold text-blue-800 mb-3">Learning & Development</h4>
            ...
            <div className="bg-purple-50 rounded-xl p-4 border border-purple-100">
              <h4 className="font-semibold text-purple-800 mb-3">Innovation & Projects</h4>
            ...
            <div className="bg-green-50 rounded-xl p-4 border border-green-100">
              <h4 className="font-semibold text-green-800 mb-3">Community Building</h4>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-slate-200">
            <div className="flex items-center gap-4 mb-4 sm:mb-0">
              <span className="text-sm text-slate-600">Connect with us:</span>
